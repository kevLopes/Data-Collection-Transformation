...
def material_cost_analyze(project_number, pipe_base_materials, material_codes, material_info):
    ...
    result_folder_path = "C:\\Users\\keven.deoliveiralope\\Documents\\Data Analyze Automatization\\Scripts\\Data-Collection-Transformation-kevLopes-DCT\\Automatized Process\\Data Pool\\DCT Process Results"
    cost_df = pd.DataFrame(cost_data)
    output_file = os.path.join(result_folder_path, f"Material_Cost_Analyze_{timestamp}.xlsx")
