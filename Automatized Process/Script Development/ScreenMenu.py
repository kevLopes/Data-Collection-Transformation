...
class MyWindow:
    def __init__(self, master):
        ...
        self.label = tk.Label(master, text="Automatic Process", font=("TkDefaultFont", 20), fg="white")
        ...
        self.folder_path_label = tk.Label(self.frame, text="Folder Path:")
    ...
    def choose_folder_path(self):
        ...
        selected_path = filedialog.askdirectory(initialdir="/", title="Select a folder")
